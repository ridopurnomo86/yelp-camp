    ...
    <main class="grid min-h-screen relative grid-cols-[50%,50%] max-[1200px]:grid-cols-1">
        <div class="flex min-[1200px]:justify-center flex-col px-40 max-[1200px]:py-10 max-[1252px]:px-10 max-[1500px]:px-20">
            <div>
                ...
                <p class="font-medium text-lg antialiased text-neutral-500 mb-4">YelpCamp is a curated list of the best camping spots on Earth. Unfiltered and un abiased reviews.</p>
                <ul class="">
                    <li class="flex items-center mb-3">
                        <img src="{{ asset('assets/icons/Checkmark.svg') }}" alt="checkmark-icon" />
                        <p class="ml-4 font-medium text-lg antialiased text-neutral-500">Add your own camp suggestions.</p>
                    </li>
                    <li class="flex items-center mb-3">
                        <img src="{{ asset('assets/icons/Checkmark.svg') }}" alt="checkmark-icon" />
                        <p class="ml-4 font-medium text-lg antialiased text-neutral-500">Leave reviews and experience.</p>
                    </li>
                    <li class="flex items-center">
                        <img src="{{ asset('assets/icons/Checkmark.svg') }}" alt="checkmark-icon" />
                        <p class="ml-4 font-medium text-lg antialiased text-neutral-500">See locations for all camps.</p>
                    </li>
                </ul>
        ...
        <div class="w-full h-full max-[1200px]:order-first bg-center">
            <img class="w-full h-full object-cover object-center max-[1200px]:aspect-[24/9] max-[1200px]:aspect-[24/9]" src="{{ asset('assets/images/Hero Image.jpg') }}" alt="hero-image-background">
        </div>
    </main>
</body>
</html>